...
try {
  ...
  const crossTeamAffectedState = {
    ...
    events: [
      ...
      { id: "ev-multi-team", type: "event", title: "Evento multi equipo", date: "2026-08-13", time: "16:00", teamId: "team-2", teamIds: ["team-2", "team-1"], playerIds: [] },
  ...
  if (!playerState.response.ok || !playerEventIds.includes("ev-create") || !playerEventIds.includes("ev-player-affected") || !playerEventIds.includes("ev-multi-team") || !playerEventIds.includes("ev-all-club")) {
